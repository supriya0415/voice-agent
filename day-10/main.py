...
# The key is the session_id, and the value is the chat history list
...
async def agent_chat(
    ...
    try:
        ...
        # Step 3: Update the chat history in our datastore
        # The chat object's history includes the user's new message and the model's response
